...
const jsonGlobs = {
  ...
  'motion':                import.meta.glob('../content/motion/*/page.json', { eager: true }),
  'graphic-illustration':  import.meta.glob('../content/graphic-illustration/*/page.json', { eager: true }),
  'graphic-digital':       import.meta.glob('../content/graphic-digital/*/page.json', { eager: true }),
  'graphic-book':          import.meta.glob('../content/graphic-book/*/page.json', { eager: true }),
  'art-negargari':         import.meta.glob('../content/art-negargari/*/page.json', { eager: true }),
  'art-golomorgh':         import.meta.glob('../content/art-golomorgh/*/page.json', { eager: true }),
  'art-tazhib':            import.meta.glob('../content/art-tazhib/*/page.json', { eager: true }),
  'exhibition-dafineh':    import.meta.glob('../content/exhibition-dafineh/*/page.json', { eager: true }),
  'exhibition-rezaabbasi': import.meta.glob('../content/exhibition-rezaabbasi/*/page.json', { eager: true }),
} as const;
...
const mediaGlobs = {
  ...
  'motion':                import.meta.glob('../content/motion/*/media/*', { eager: true, query: '?url', import: 'default' }),
  'graphic-illustration':  import.meta.glob('../content/graphic-illustration/*/media/*', { eager: true, query: '?url', import: 'default' }),
  'graphic-digital':       import.meta.glob('../content/graphic-digital/*/media/*', { eager: true, query: '?url', import: 'default' }),
  'graphic-book':          import.meta.glob('../content/graphic-book/*/media/*', { eager: true, query: '?url', import: 'default' }),
  'art-negargari':         import.meta.glob('../content/art-negargari/*/media/*', { eager: true, query: '?url', import: 'default' }),
  'art-golomorgh':         import.meta.glob('../content/art-golomorgh/*/media/*', { eager: true, query: '?url', import: 'default' }),
  'art-tazhib':            import.meta.glob('../content/art-tazhib/*/media/*', { eager: true, query: '?url', import: 'default' }),
  'exhibition-dafineh':    import.meta.glob('../content/exhibition-dafineh/*/media/*', { eager: true, query: '?url', import: 'default' }),
  'exhibition-rezaabbasi': import.meta.glob('../content/exhibition-rezaabbasi/*/media/*', { eager: true, query: '?url', import: 'default' }),
} as const;

// 3) WebP URLs (pre-generated by scripts/generate-webp.mjs).
const webpGlobs = {
  'ai':                    import.meta.glob('../content/ai/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  'motion':                import.meta.glob('../content/motion/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  'graphic-illustration':  import.meta.glob('../content/graphic-illustration/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  'graphic-digital':       import.meta.glob('../content/graphic-digital/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  'graphic-book':          import.meta.glob('../content/graphic-book/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  'art-negargari':         import.meta.glob('../content/art-negargari/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  'art-golomorgh':         import.meta.glob('../content/art-golomorgh/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  'art-tazhib':            import.meta.glob('../content/art-tazhib/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  'exhibition-dafineh':    import.meta.glob('../content/exhibition-dafineh/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
  'exhibition-rezaabbasi': import.meta.glob('../content/exhibition-rezaabbasi/*/media/*.webp', { eager: true, query: '?url', import: 'default' }),
};
...
export async function resolveAlbumMediaUrls(
  ...
  const media = await Promise.all(album.media.map(async (item) => {
    if (item.type === 'image') {
      ...
      const hasColorPalette = false; // disabled — kept off for new minimal design
